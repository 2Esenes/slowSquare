...
namespace CrazyGames
{
    ...
    {
        #region XenoliaEvents
        public Action OnAdOpened;
        public Action OnAdClosed;
        public Action OnAdComplated;
        public Action OnAdError;
        #endregion
        ...
        private void Awake()
        {
            ...
            CrazySDK.Instance.AddEventListener(CrazySDKEvent.adCompleted, ev => AdComplated());
        ...
        private bool IsRunningAd
        {
            ...
            set
            {
                ...
                AudioListener.volume = _isRunningAd ? 0 : origAudioListenerVolume;
        ...
        private void AdComplated()
        {
            completedAdRequest(CrazySDKEvent.adCompleted);
            Debug.Log("Complate test");
            OnAdComplated?.Invoke();
        }
